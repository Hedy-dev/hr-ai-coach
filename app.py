...
#     # Кэшируем данные, чтобы не перечитывать файл при каждом клике
...
#         student_ans = st.text_area("Ваш ответ:", height=200, placeholder="Напишите, как бы вы ответили на этот вопрос...")
...
#                     report = analyzer.analyze(selected_q, hr_list, student_ans)
#                     st.markdown(report)
#         else:
#             st.info("Здесь появится разбор вашего ответа после нажатия кнопки.")

# else:
#     st.warning("👈 Для начала работы введите API-ключ и загрузите файл с ответами HR в боковом меню.")
